...
public class BinarySortTester {
    @Test
    @DisplayName("Binary Sort Test")
    public void binarySortTest() throws SortingException, PrimitiveConversionException {
        ...
        Assertions.assertArrayEquals(sortedInts, binarySort.sort(unsortedInts));
    }
}
